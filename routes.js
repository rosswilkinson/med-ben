...
module.exports = {
  bind : function (app, assetPath) {
    ...
    app.get('/mb-joinup/mb11-start.html', function (req, res) {
        resetFunction();
        res.render('mb11/mb11-start', {
            'sbBen' : sbBen,
            'ccBen' : ccBen,
            'assetPath' : assetPath 
        });
    ...
    app.get('/mb-joinup/mb11-home', function (req, res) {
        if(req.param('medben')){
       ...
       app.get('/mb-joinup/mb11-home2', function (req, res) {
        res.render('mb11/mb11-home2', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
        });
       ...
       app.get('/mb-joinup/mb11-home2-noben', function (req, res) {
        res.render('mb11/mb11-home2-noben', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
        });
     ...
     app.get('/mb-joinup/mb11-add', function (req, res) {
        res.render('mb11/mb11-add', {
          'assetPath' : assetPath 
        });
    });
      
    app.get('/mb-joinup/mb11-add-amount', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb11/mb11-add-amount', {
          'assetPath' : assetPath 
        });
    });
      
          app.get('/mb-joinup/mb11-exit-survey', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb11/mb11-exit-survey', {
          'assetPath' : assetPath 
        });
    });
    ...
    app.get('/mb-joinup/mb11-question-a', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-question-a', {
            'employer' : employer,
      ...
      app.get('/mb-joinup/mb11-new', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-new', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb-joinup/mb11-question-b', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-question-b', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb-joinup/mb11-update', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-update', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb-joinup/mb11-update-only', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb-joinup/mb11-summary', function (req, res) {
        tempValue = req.query.update;
        res.render('mb11/mb11-summary', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
       ...
       app.get('/mb-joinup/mb11-summary-add', function (req, res) {
        addedAmount = req.query.addedAmount;
        res.render('mb11/mb11-summary-add', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
       ...
       app.get('/mb-joinup/mb11-summary-update-only', function (req, res) {
        tempValue = req.query.update;
        res.render('mb11/mb11-summary-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb-joinup/mb11-done', function (req, res) {
//        if (req.query.amount) {
    ...
    app.get('/mb-joinup/mb11-home-updated', function (req, res) {
        res.render('mb11/mb11-home-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
    ...
    app.get('/mb-joinup/mb11-finish', function (req, res) {
        updateFunction();
        res.render('mb11/mb11-finish', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb-joinup/mb11-remove', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb11/mb11-remove', {
            'employer' : employer,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb-joinup/mb11-remove-b', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb11/mb11-remove-b', {
            'employer' : employer,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
        ...
        app.get('/mb-joinup/mb11-tax-on-income-updated', function (req, res) {
        res.render('mb11/mb11-tax-on-income-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
         ...
         app.get('/mb-joinup/mb11-tax-free-amount-updated', function (req, res) {
        res.render('mb11/mb11-tax-free-amount-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb-joinup/mb11-check-income-tax-updated', function (req, res) {
        res.render('mb11/mb11-check-income-tax-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb-joinup/mb11-ended-amend', function (req, res) {
        res.render('mb11/mb11-ended-amend', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb-joinup/mb11-about-a-change-amended', function (req, res) {
        res.render('mb11/mb11-about-a-change-amended', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb-joinup/mb11-tax-on-income', function (req, res) {
        res.render('mb11/mb11-tax-on-income', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb-joinup/mb11-tax-codes-updated', function (req, res) {
        res.render('mb11/mb11-tax-codes-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
    ...
    app.get('/car-service/car-1.html', function (req, res) {
      ...
      /*MB 10 */
       ...
       app.get('/mb10/mb10-pta-home.html', function (req, res) {
      res.render('mb10/mb10-pta-home', {'assetPath' : assetPath });
    });
      
      
      
      app.get('/mb10/mb10-tax-on-income.html', function (req, res) {
      res.render('mb10/mb10-tax-on-income', {'assetPath' : assetPath });
    });
      
        app.get('/mb10/mb10-check-income-tax.html', function (req, res) {
      res.render('mb10/mb10-check-income-tax', {'assetPath' : assetPath });
    });
      
      app.get('/mb10/mb10-tax-codes.html', function (req, res) {
      res.render('mb10/mb10-tax-codes', {'assetPath' : assetPath });
    });
      
        app.get('/mb10/mb10-tax-free-amount.html', function (req, res) {
      res.render('mb10/mb10-tax-free-amount', {'assetPath' : assetPath });
    });
      
      
      
         app.get('/mb10/mb10-about-a-change.html', function (req, res) {
      res.render('mb10/mb10-about-a-change', {'assetPath' : assetPath });
    });
      
    
      
      app.get('/mb10v2/mb10v2-tax-on-income.html', function (req, res) {
      res.render('mb10v2/mb10v2-tax-on-income', {'assetPath' : assetPath });
    });
      
        app.get('/mb10v2/mb10v2-check-income-tax.html', function (req, res) {
      res.render('mb10v2/mb10v2-check-income-tax', {'assetPath' : assetPath });
    });
      
      app.get('/mb10v2/mb10v2-tax-codes.html', function (req, res) {
      res.render('mb10v2/mb10v2-tax-codes', {'assetPath' : assetPath });
    });
      
         app.get('/mb10v2/mb10v2-about-a-change.html', function (req, res) {
      res.render('mb10v2/mb10v2-about-a-change', {'assetPath' : assetPath });
    });
      ...
      res.render('mb10-1/mb10-1-home-content-noben', {'assetPath' : assetPath });
           ...
           app.get('/mb11/mb11-about-a-change.html', function (req, res) {
      res.render('mb11/mb11-about-a-change', {'assetPath' : assetPath });
    });
...
/*mb3 */
    ...
    app.get('/mb10/mb10-start.html', function (req, res) {
        resetFunction();
        res.render('mb10/mb10-start', {
            'sbBen' : sbBen,
            'ccBen' : ccBen,
            'assetPath' : assetPath 
        });
    ...
    app.get('/mb10/mb10-home', function (req, res) {
        res.render('mb10/mb10-home', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
        });
       ...
       app.get('/mb10/mb10-home2', function (req, res) {
        res.render('mb10/mb10-home2', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
        });
    ...
    app.get('/mb10/mb10-add-amount', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb10/mb10-add-amount', {
          'assetPath' : assetPath 
        });
    });
      
          app.get('/mb10/mb10-exit-survey', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb10/mb10-exit-survey', {
          'assetPath' : assetPath 
        });
    });
    ...
    app.get('/mb10/mb10-question-a', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10/mb10-question-a', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb10/mb10-question-b', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10/mb10-question-b', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb10/mb10-update', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10/mb10-update', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb10/mb10-update-only', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10/mb10-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb10/mb10-summary', function (req, res) {
        tempValue = req.query.update;
        res.render('mb10/mb10-summary', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
       ...
       app.get('/mb10/mb10-summary-add', function (req, res) {
        addedAmount = req.query.addedAmount;
        res.render('mb10/mb10-summary-add', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
       ...
       app.get('/mb10/mb10-summary-update-only', function (req, res) {
        tempValue = req.query.update;
        res.render('mb10/mb10-summary-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb10/mb10-done', function (req, res) {
        if (req.query.amount) {
            tempValue = req.query.amount;
            updateFunction();
        }
        res.render('mb10/mb10-done', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb10/mb10-home-updated', function (req, res) {
        res.render('mb10/mb10-home-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
    ...
    app.get('/mb10/mb10-finish', function (req, res) {
        updateFunction();
        res.render('mb10/mb10-finish', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb10/mb10-remove', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb10/mb10-remove', {
            'employer' : employer,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb10/mb10-remove-b', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb10/mb10-remove-b', {
            'employer' : employer,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
        ...
        app.get('/mb10/mb10-tax-on-income-updated', function (req, res) {
        res.render('mb10/mb10-tax-on-income-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
         ...
         app.get('/mb10/mb10-tax-free-amount-updated', function (req, res) {
        res.render('mb10/mb10-tax-free-amount-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb10/mb10-check-income-tax-updated', function (req, res) {
        res.render('mb10/mb10-check-income-tax-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb10/mb10-ended-amend', function (req, res) {
        res.render('mb10/mb10-ended-amend', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb10/mb10-about-a-change-amended', function (req, res) {
        res.render('mb10/mb10-about-a-change-amended', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb10/mb10-tax-on-income', function (req, res) {
        res.render('mb10/mb10-tax-on-income', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb10/mb10-tax-codes-updated', function (req, res) {
        res.render('mb10/mb10-tax-codes-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
    ...
    app.get('/mb10v2/mb10v2-start.html', function (req, res) {
        resetFunction();
        res.render('mb10v2/mb10v2-start', {
            'sbBen' : sbBen,
            'ccBen' : ccBen,
            'assetPath' : assetPath 
        });
    ...
    app.get('/mb10v2/mb10v2-home', function (req, res) {
        res.render('mb10v2/mb10v2-home', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
        });
     ...
     app.get('/mb10v2/mb10v2-add', function (req, res) {
        res.render('mb10v2/mb10v2-add', {
          'assetPath' : assetPath 
        });
    });
      
    app.get('/mb10v2/mb10v2-add-amount', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb10v2/mb10v2-add-amount', {
          'assetPath' : assetPath 
        });
    });
    ...
    app.get('/mb10v2/mb10v2-question-a', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10v2/mb10v2-question-a', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb10v2/mb10v2-question-b', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10v2/mb10v2-question-b', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb10v2/mb10v2-update', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10v2/mb10v2-update', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb10v2/mb10v2-update-only', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb10v2/mb10v2-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb10v2/mb10v2-summary', function (req, res) {
        tempValue = req.query.update;
        res.render('mb10v2/mb10v2-summary', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
       ...
       app.get('/mb10v2/mb10v2-summary-add', function (req, res) {
        addedAmount = req.query.addedAmount;
        res.render('mb10v2/mb10v2-summary-add', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
       ...
       app.get('/mb10v2/mb10v2-summary-update-only', function (req, res) {
        tempValue = req.query.update;
        res.render('mb10v2/mb10v2-summary-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb10v2/mb10v2-done', function (req, res) {
        if (req.query.amount) {
            tempValue = req.query.amount;
            updateFunction();
        }
        res.render('mb10v2/mb10v2-done', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb10v2/mb10v2-home-updated', function (req, res) {
        res.render('mb10v2/mb10v2-home-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
    ...
    app.get('/mb10v2/mb10v2-finish', function (req, res) {
        updateFunction();
        res.render('mb10v2/mb10v2-finish', {
            'employer' : employer,
            'currentValue' : currentValue,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
    ...
    app.get('/mb10v2/mb10v2-remove', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb10v2/mb10v2-remove', {
            'employer' : employer,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
       ...
       app.get('/mb10v2/mb10v2-remove-b', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb10v2/mb10v2-remove-b', {
            'employer' : employer,
            'tempValue' : tempValue,
            'sbBen' : sbBen,
            'ccBen' : ccBen,
        ...
        app.get('/mb10v2/mb10v2-tax-on-income-updated', function (req, res) {
        res.render('mb10v2/mb10v2-tax-on-income-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb10v2/mb10v2-check-income-tax-updated', function (req, res) {
        res.render('mb10v2/mb10v2-check-income-tax-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb10v2/mb10v2-tax-free-amount-updated', function (req, res) {
        res.render('mb10v2/mb10v2-tax-free-amount-updated', {
          ...
          'addedAmount' : addedAmount
           ...
           app.get('/mb10v2/mb10v2-ended-amend', function (req, res) {
        res.render('mb10v2/mb10v2-ended-amend', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb10v2/mb10v2-about-a-change-amended', function (req, res) {
        res.render('mb10v2/mb10v2-about-a-change-amended', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
          'addedAmount' : addedAmount
           ...
           app.get('/mb10v2/mb10v2-tax-on-income', function (req, res) {
        res.render('mb10v2/mb10v2-tax-on-income', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
       ...
       app.get('/mb10v2/mb10v2-tax-codes-updated', function (req, res) {
        res.render('mb10v2/mb10v2-tax-codes-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          'addedEmployer' : addedEmployer,
    ...
    app.get('/mb11/mb11-start.html', function (req, res) {
        resetFunction();
        res.render('mb11/mb11-start', {
            'sbBen' : sbBen,
            'ccBen' : ccBen,
    ...
    app.get('/mb11/mb11-home', function (req, res) {
       ...
       app.get('/mb11/mb11-home2', function (req, res) {
        res.render('mb11/mb11-home2', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
       ...
       app.get('/mb11/mb11-home2-noben', function (req, res) {
        res.render('mb11/mb11-home2-noben', {
            'assetPath' : assetPath,
            'addedEmployer' : addedEmployer,
            'addedAmount' : addedAmount
     ...
     app.get('/mb11/mb11-add', function (req, res) {
        res.render('mb11/mb11-add', {
          'assetPath' : assetPath 
        });
    });
      
    app.get('/mb11/mb11-add-amount', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb11/mb11-add-amount', {
          'assetPath' : assetPath 
        });
          ...
          app.get('/mb11/mb11-exit-survey', function (req, res) {
        addedEmployer = req.query.addedEmployer;
        res.render('mb11/mb11-exit-survey', {
          'assetPath' : assetPath 
        });
    ...
    app.get('/mb11/mb11-question-a', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-question-a', {
            'employer' : employer,
      ...
      app.get('/mb11/mb11-new', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-new', {
            'employer' : employer,
       ...
       app.get('/mb11/mb11-question-b', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-question-b', {
            'employer' : employer,
    ...
    app.get('/mb11/mb11-update', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-update', {
            'employer' : employer,
       ...
       app.get('/mb11/mb11-update-only', function (req, res) {
        employer = req.query.employer;
        summaryFunction();
        res.render('mb11/mb11-update-only', {
            'employer' : employer,
    ...
    app.get('/mb11/mb11-summary', function (req, res) {
        tempValue = req.query.update;
        res.render('mb11/mb11-summary', {
            'employer' : employer,
            'currentValue' : currentValue,
       ...
       app.get('/mb11/mb11-summary-add', function (req, res) {
        addedAmount = req.query.addedAmount;
        res.render('mb11/mb11-summary-add', {
            'employer' : employer,
            'currentValue' : currentValue,
       ...
       app.get('/mb11/mb11-summary-update-only', function (req, res) {
        tempValue = req.query.update;
        res.render('mb11/mb11-summary-update-only', {
            'employer' : employer,
            'currentValue' : currentValue,
...
//        if (req.query.amount) {
    ...
    app.get('/mb11/mb11-home-updated', function (req, res) {
        res.render('mb11/mb11-home-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
    ...
    app.get('/mb11/mb11-finish', function (req, res) {
        updateFunction();
        res.render('mb11/mb11-finish', {
            'employer' : employer,
            'currentValue' : currentValue,
    ...
    app.get('/mb11/mb11-remove', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb11/mb11-remove', {
            'employer' : employer,
       ...
       app.get('/mb11/mb11-remove-b', function (req, res) {
        tempValue = 0;
        employer = req.query.employer;
        res.render('mb11/mb11-remove-b', {
            'employer' : employer,
        ...
        app.get('/mb11/mb11-tax-on-income-updated', function (req, res) {
        res.render('mb11/mb11-tax-on-income-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
         ...
         app.get('/mb11/mb11-tax-free-amount-updated', function (req, res) {
        res.render('mb11/mb11-tax-free-amount-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
       ...
       app.get('/mb11/mb11-check-income-tax-updated', function (req, res) {
        res.render('mb11/mb11-check-income-tax-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          ...
          'addedAmount' : addedAmount
           ...
           app.get('/mb11/mb11-ended-amend', function (req, res) {
        res.render('mb11/mb11-ended-amend', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          ...
          'addedAmount' : addedAmount
           ...
           app.get('/mb11/mb11-about-a-change-amended', function (req, res) {
        res.render('mb11/mb11-about-a-change-amended', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
          ...
          'addedAmount' : addedAmount
           ...
           app.get('/mb11/mb11-tax-on-income', function (req, res) {
        res.render('mb11/mb11-tax-on-income', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
       ...
       app.get('/mb11/mb11-tax-codes-updated', function (req, res) {
        res.render('mb11/mb11-tax-codes-updated', {
          'sbBen' : sbBen,
          'ccBen' : ccBen,
          'assetPath' : assetPath,
